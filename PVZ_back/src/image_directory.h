...
static map<int, int> blink_of = {
    ...
    {BUCKET_ZOMBIE_WALK_DIRECTORY, BUCKET_ZOMBIE_WALK_BLINK_DIRECTORY},
    {BUCKET_ZOMBIE_EATING_DIRECTORY, BUCKET_ZOMBIE_EATING_BLINK_DIRECTORY}
...
static map<int, int> cold_of = {
    ...
    {BUCKET_ZOMBIE_WALK_DIRECTORY, BUCKET_ZOMBIE_WALK_COLD_DIRECTORY},
    {BUCKET_ZOMBIE_EATING_DIRECTORY, BUCKET_ZOMBIE_EATING_COLD_DIRECTORY}
